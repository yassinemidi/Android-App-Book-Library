...
class profile : Fragment() {
    ...
    override fun onCreateView(
        ...
        val nom=binding.etlastNamep
        val prenom=binding.etprenomp
        val email=binding.etemailp
        val password=binding.etpasswordp
        val confpassword=binding.etconfirmPassword
        val btn=binding.btnUpdate
