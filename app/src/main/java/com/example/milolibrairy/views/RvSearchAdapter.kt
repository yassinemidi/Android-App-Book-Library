...
class RvSearchAdapter(val data: ArrayList<book>, val context: Context, val activity: IndexActivity) : RecyclerView.Adapter<RvSearchAdapter.MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val action=search_listDirections.actionSearchListToBookDetails2(book.id)
